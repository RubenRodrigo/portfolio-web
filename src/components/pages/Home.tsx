...
export const Home = () => {
	...
	return (
		<div className="relative h-full w-full overflow-y-auto">
			<div
				className="w-full pt-24 md:pt-28 lg:pt-32 flex"
			>
				<div className="w-full flex flex-col xl:flex-row xl:px-28 md:px-10 px-5 max-w-screen-2xl mx-auto gap-10 self-center">
